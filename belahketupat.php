            ...
            <div class="card-body">
                <form action="#" method="POST" role="form" enctype="multipsrt/form-data">
                    <div class="form-group">
                        <label>Masukkan Nilai Sisi (s)</label>
                        <input type="text" name="sisi" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Masukkan Nilai Diagonal 1 (d1)</label>
                        <input type="text" name="d1" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Masukkan Nilai Diagonal 2 (d2)</label>
                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        echo "<b>Jawaban</b><br/>";
                        echo "Diketahui;<br/>";
                        echo "Nilai Sisi = $sisi $satuan<br/>";
                        echo "Nilai Diagonal 1 = $d1 $satuan<br/>";
                        echo "Nilai Diagonal 2 = $d2 $satuan<br/>";
                        echo "Hasil nilai keliling Belah Ketupat adalah $rumusK $satuan<br/>";
                        echo "Hasil nilai luas Belah Ketupat adalah $rumusL $satuan1<br/>";
                    }
                ?>
                </div>
            </div>
