        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="#" method="POST" role="form" enctype="multipsrt/form-data">
                    ...
                    <div class="form-group">
                        <label>Masukkan Nilai Sisi Miring (b)</label>
                        <input type="text" name="miring" class="form-control" required>
                    </div>
                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        echo "Nilai Sisi Miring = $miring $satuan<br/>";
                        echo "Hasil nilai keliling Jajar Genjang adalah $rumusK $satuan<br/>";
                        echo "Hasil nilai luas Jajar Genjang adalah $rumusL $satuan1<br/>";
                    }
                ?>
                </div>
            </div>
